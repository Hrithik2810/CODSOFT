...
# Generate button
generate_button = tk.Button(root, text="Generate Password", command=generate_password,font=("Comic Sans MS",14))
generate_button.grid(row=8, column=1,pady=10)

# Reset button
reset_button = tk.Button(root, text="Reset", command=reset_fields,font=("Comic Sans MS",14))
